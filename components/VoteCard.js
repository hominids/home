...
const VoteCard = ({ id, title, description, progress }) => {
    return (
        <div draggable={false} src={id} className="grid border-2 border-blue-300 justify-items-center h-50 w-screen p-4 rounded-xl bg-gradient-to-tr from-indigo-200 to-blue-100">
            ...
            <p className="border-2 border-blue-400 rounded-lg w-11/12 p-3 m-5 cursor-default text-indigo-900">{description}</p>
